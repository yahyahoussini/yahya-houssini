...
const Header = () => {
  ...
  const handleDownloadCV = () => {
    ...
    link.href = '/yahya-houssini.pdf';
    link.download = 'yahya-houssini.pdf';
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden lg:flex items-center gap-4">
            <LanguageSwitcher />
            <Button variant="outline" className="flex items-center gap-2" onClick={handleDownloadCV}>
        ...
        <div className="lg:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 bg-background/95 backdrop-blur-md border-b border-border/50">
            ...
            <div className="px-3 py-2 space-y-2">
              <LanguageSwitcher />
              <Button variant="outline" className="flex items-center gap-2 w-full" onClick={handleDownloadCV}>
                <Download className="w-4 h-4" />
                {t('nav.downloadCV')}
              </Button>
            </div>
